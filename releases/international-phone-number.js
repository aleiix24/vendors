(function() {
  ...
  angular.module("internationalPhoneNumber", []).constant('ipnConfig', {
    ...
    preferredCountries: ['us', 'gb', 'es', 'sg'],
    utilsScript: ""
        ...
        link: function(scope, element, attrs, ctrl) {
          ...
          watchOnce = scope.$watch('ngModel', function(newValue) {
            return scope.$$postDigest(function() {
              ...
              if (!(attrs.skipUtilScriptDownload !== void 0)) {
                element.intlTelInput('loadUtils', '/vendor/intl-tel-input/lib/libphonenumber/build/utils.js');
              }
              return watchOnce();
            });
          });
